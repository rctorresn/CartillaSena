...
<body>
    <div class="container-total">
        ...
        <div class="container-2">
            ...
            <class class="contenido-2-3">
                <!-- <h1><span class="naranja">1</span></h1> -->
                    <div>
                        <h3 class="h3">4. Listen and complete the blanks with words from the box below.</h3>
                    </div>
        ...
        <div class="container-4">
            ...
            <div class="footermenu">
                ...
                <a href="U1_Pag4.php"><input type="image" name="before" src="../botones/Interfaz/before_but.png" alt="" class="img-logos" onmouseover="this.src='../botones/Interfaz/before_but_sobre.png';" onmouseout="this.src='../botones/Interfaz/before_but.png';" onclick="this.src='../botones/Interfaz/before_but_press.png';">
                <a href="U1_Pag6.php"><input type="image" name="next" src="../botones/Interfaz/next_but.png" alt="" class="img-logos" onmouseover="this.src='../botones/Interfaz/next_but_sobre.png';" onmouseout="this.src='../botones/Interfaz/next_but.png';" onclick="this.src='../botones/Interfaz/next_but_press.png';"></a>
            </div>
        </div>
    </div>

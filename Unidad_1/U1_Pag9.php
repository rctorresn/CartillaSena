...
<div class="container-total-1">
    ...
    <div class="container-2">
        ...
        <div class="contenido-1">
            ...
            <div class="contenido-2">
                <img src="../Imagenes\ImagesUnit1\pag15\image_13.png" alt="">
                ...
                <div><audio src="../Sonidos/Sonidos_U1/pagina 8 AUDIO 1.mp3" preload="auto" controls></audio></div>
        </div>
       <div class="fullImagen">
            <div class="Pag9-U1" ></div>
    ...
    <div class="container-4">
        ...
        <div class="footermenu">
            ...
            <a href="U1_Pag8.php"><input type="image" name="before" src="../botones/Interfaz/before_but.png" alt="" class="img-logos" onmouseover="this.src='../botones/Interfaz/before_but_sobre.png';" onmouseout="this.src='../botones/Interfaz/before_but.png';" onclick="this.src='../botones/Interfaz/before_but_press.png';">
            <a href="U1_Pag10.php"><input type="image" name="next" src="../botones/Interfaz/next_but.png" alt="" class="img-logos" onmouseover="this.src='../botones/Interfaz/next_but_sobre.png';" onmouseout="this.src='../botones/Interfaz/next_but.png';" onclick="this.src='../botones/Interfaz/next_but_press.png';"></a>
        </div>
    </div>

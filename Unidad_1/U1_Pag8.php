...
<div class="container-total">
    ...
    <div class="container-2">
        ...
        <class class="contenido-2-2">
            <!-- <h1><span class="naranja">1</span></h1> -->
            <img src="../ImagenesPages\pag9\images_10.png" class="imagen3" alt="">
                <div>
                    <h3 class="h3">7. Write which event(s) the following statements refer to.</h3>
                </div>
            </class>
    ...
    <div class="container-4">
        ...
        <div class="footermenu">
            ...
            <a href="U1_Pag7.php"><input type="image" name="before" src="../botones/Interfaz/before_but.png" alt="" class="img-logos" onmouseover="this.src='../botones/Interfaz/before_but_sobre.png';" onmouseout="this.src='../botones/Interfaz/before_but.png';" onclick="this.src='../botones/Interfaz/before_but_press.png';">
            <a href="U1_Pag9.php"><input type="image" name="next" src="../botones/Interfaz/next_but.png" alt="" class="img-logos" onmouseover="this.src='../botones/Interfaz/next_but_sobre.png';" onmouseout="this.src='../botones/Interfaz/next_but.png';" onclick="this.src='../botones/Interfaz/next_but_press.png';"></a>
        </div>
    </div>
